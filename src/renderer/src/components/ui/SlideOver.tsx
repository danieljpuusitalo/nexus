...
export default function SlideOver({ open, onClose, title, children }: SlideOverProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      {/* Panel */}
      <div className="relative w-full max-w-lg bg-white dark:bg-zinc-950 border-l border-zinc-200 dark:border-zinc-800/60 h-full flex flex-col slide-over-enter">
        {/* Header */}
        <div className="flex items-center justify-between px-6 h-14 border-b border-zinc-200 dark:border-zinc-800/60 flex-shrink-0">
